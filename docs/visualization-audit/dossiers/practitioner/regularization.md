# Regularization - Diagram Audit

## Identity
- Track: practitioner
- Route: `/algorithms/regularization`
- Component: `src/components/ui/visualizations/RegularizationViz.tsx`
- Review date: 2026-06-06
- Disposition: REFINE
- Simulation class: simplified

## Intended Teaching Purpose
- Module objective served: L1/L2 geometry, penalties, and coefficient shrinkage.
...
- Governing verification: L1/L2 geometry, penalties, and coefficient shrinkage.
...
|---|---|---|---|---|
| VIZ-PRC-023 | S3 | Independent boundary and reset oracle coverage is incomplete. | Run the focused diagram accuracy suite. | Add test-local calculations and displayed-value assertions. |
