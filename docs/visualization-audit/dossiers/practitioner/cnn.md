...
- Component: `src/components/ui/visualizations/CNNViz.tsx`
- Review date: 2026-06-06
- Disposition: KEEP
- Simulation class: exact

## Intended Teaching Purpose
- Module objective served: Kernel placement, convolution sum, and output dimensions.
...
- Governing verification: Kernel placement, convolution sum, and output dimensions.
