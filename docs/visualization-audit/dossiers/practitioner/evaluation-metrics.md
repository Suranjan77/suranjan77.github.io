# Evaluation Metrics - Diagram Audit

## Identity
- Track: practitioner
- Route: `/algorithms/evaluation-metrics`
- Component: `src/components/ui/visualizations/EvaluationMetricsViz.tsx`
- Review date: 2026-06-06
- Disposition: KEEP
- Simulation class: exact

## Intended Teaching Purpose
- Module objective served: Confusion matrix, precision, recall, F1, and threshold edges.
...
- Governing verification: Confusion matrix, precision, recall, F1, and threshold edges.
