...
- Component: `src/components/ui/visualizations/MCMCViz.tsx`
- Review date: 2026-06-06
- Disposition: REFINE
- Simulation class: seeded

## Intended Teaching Purpose
- Module objective served: Proposal, acceptance ratio, trace, and histogram consistency.
...
- Governing verification: Proposal, acceptance ratio, trace, and histogram consistency.
...
|---|---|---|---|---|
| VIZ-PRC-019 | S3 | Independent boundary and reset oracle coverage is incomplete. | Run the focused diagram accuracy suite. | Add test-local calculations and displayed-value assertions. |
