...
- Module objective served: Distance ordering, voting, ties, and boundary classification.
...
- Governing verification: Distance ordering, voting, ties, and boundary classification.
