# Anomaly Detection - Diagram Audit

## Identity
- Track: practitioner
- Route: `/algorithms/anomaly-detection`
- Component: `src/components/ui/visualizations/AnomalyDetectionViz.tsx`
- Review date: 2026-06-06
- Disposition: REFINE
- Simulation class: simplified

## Intended Teaching Purpose
- Module objective served: Score direction, threshold, contamination, and counts.
...
- Governing verification: Score direction, threshold, contamination, and counts.
...
|---|---|---|---|---|
| VIZ-PRC-020 | S3 | Independent boundary and reset oracle coverage is incomplete. | Run the focused diagram accuracy suite. | Add test-local calculations and displayed-value assertions. |
