# Probability Theory - Diagram Audit

## Identity
- Track: foundations
- Route: `/algorithms/probability-theory`
- Component: `src/components/ui/visualizations/ProbabilityViz.tsx`
- Review date: 2026-06-06
- Disposition: REFINE
- Simulation class: seeded

## Intended Teaching Purpose
- Module objective served: Empirical frequencies, normalization, TVD, and convergence.
...
- Governing verification: Empirical frequencies, normalization, TVD, and convergence.
...
|---|---|---|---|---|
| VIZ-FND-003 | S3 | Independent boundary and reset oracle coverage is incomplete. | Run the focused diagram accuracy suite. | Add test-local calculations and displayed-value assertions. |
