# Calculus - Diagram Audit

## Identity
- Track: foundations
- Route: `/algorithms/calculus`
- Component: `src/components/ui/visualizations/CalculusViz.tsx`
- Review date: 2026-06-06
- Disposition: KEEP
- Simulation class: exact

## Intended Teaching Purpose
- Module objective served: Secant slope and analytical derivative convergence.
...
- Governing verification: Secant slope and analytical derivative convergence.
...
- Current oracle status: Implemented in `VisualizationAccuracyFoundations.test.tsx`.
...
Displayed values are checked against deterministic expected results.
...
|---|---|---|---|---|
| None | None | No open release defect. | Run the focused diagram accuracy suite. | None. |
...
- Simplifications disclosed: exact.

## Verification
- Focused unit tests: `D3Visualization.test.tsx`, `VisualizationAudit.test.tsx`.
- Accuracy tests: `VisualizationAccuracyFoundations.test.tsx`.
