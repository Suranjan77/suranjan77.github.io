# Backpropagation - Diagram Audit

## Identity
- Track: modern-ai
- Route: `/algorithms/backpropagation`
- Component: `src/components/ui/visualizations/BackpropagationViz.tsx`
- Review date: 2026-06-06
- Disposition: REFINE
- Simulation class: exact

## Intended Teaching Purpose
- Module objective served: Chain rule, gradient accumulation, and finite differences.
...
- Governing verification: Chain rule, gradient accumulation, and finite differences.
...
|---|---|---|---|---|
| VIZ-MAI-034 | S3 | Independent boundary and reset oracle coverage is incomplete. | Run the focused diagram accuracy suite. | Add test-local calculations and displayed-value assertions. |
