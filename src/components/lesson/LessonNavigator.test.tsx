...
describe("LessonNavigator", () => {
  it("exposes track movement and section shortcuts", () => {
    ...
    expect(
      screen.getByRole("link", { name: /Previous module: Calculus/i }),
    ).toHaveAttribute("href", "/algorithms/calculus");
    expect(
      screen.getByRole("link", { name: /Next module: Probability/i }),
    ).toHaveAttribute("href", "/algorithms/probability-theory");
  });
