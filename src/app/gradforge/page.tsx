      ...
      <section className="border-b border-outline px-5 py-16 sm:px-8 lg:px-12">
        <div className="mx-auto max-w-[1360px]">
          <nav
            ...
            className="mb-8 flex flex-wrap items-center gap-2 font-mono text-[10px] uppercase tracking-[0.18em] text-on-surface-variant"
          >
          ...
          <div className="grid gap-10 lg:grid-cols-[minmax(0,570px)_1fr] lg:items-end">
            <div>
              <div className="flex flex-wrap items-center gap-3">
                ...
                <span className="border border-outline bg-surface-container-high px-2 py-1 font-mono text-[9px] uppercase tracking-[0.16em] text-on-surface-variant">
                  Modern AI Track
                </span>
              </div>
          ...
          <div className="flex flex-col gap-4 border-b border-outline px-5 py-4 sm:flex-row sm:items-center sm:justify-between sm:px-7">
            ...
            <div className="flex flex-wrap gap-2">
              <Link
                ...
                className="border border-outline bg-surface-container px-4 py-2 font-mono text-[10px] uppercase tracking-[0.16em] text-on-surface transition-colors hover:border-primary hover:text-primary"
              >
                Read Backpropagation
              </Link>
              <Link
                href="/playground"
                className="border border-outline bg-surface px-4 py-2 font-mono text-[10px] uppercase tracking-[0.16em] text-on-surface-variant transition-colors hover:border-primary hover:text-primary"
              >
                Neural Playground
              </Link>
            </div>
      ...
      <section className="border-b border-outline px-5 py-16 sm:px-8 lg:px-12">
        <div className="mx-auto max-w-[1360px]">
          <div className="mb-8 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
            <div>
              <p className="font-mono text-[10px] uppercase tracking-[0.2em] text-primary">Lab workflow</p>
          ...
          <div className="grid gap-px border border-outline bg-border sm:grid-cols-2 lg:grid-cols-4">
            {workflow.map(([step, title, description]) => (
              <article key={step} className="bg-surface p-6">
                <p className="font-mono text-[11px] text-on-surface-variant">{step}</p>
      ...
      <section className="px-5 py-16 sm:px-8 lg:px-12">
        <div className="mx-auto grid max-w-[1360px] gap-px border border-outline bg-border lg:grid-cols-[0.8fr_1.2fr]">
          <div className="bg-primary p-7 text-on-primary sm:p-9">
            ...
            <Link
              href="/algorithms/backpropagation"
              className="mt-7 inline-flex border border-on-primary/50 px-4 py-2 font-mono text-[10px] uppercase tracking-[0.16em] transition-colors hover:bg-on-primary hover:text-primary"
            >
              Open the lesson →
            </Link>
          </div>
